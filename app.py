...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --text-color-secondary: rgba(28, 28, 30, 0.7);
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background-color: #EFEFF4; /* Светлый фон для контраста с UI */
        ...
        .app-container-wrapper.bg-blur { 
            ...
            transform: scale(1.05); /* Увеличиваем фон, чтобы размытые края не были видны */
        }
        ...
        .neumorphic-btn {
            ...
            background: linear-gradient(145deg, #f0f0f5, #cacace);
            box-shadow: var(--neumorphic-shadow-out);
        }
        ...
        .image-drop-area {
            ...
            align-items: center;
            border-radius: 16px;
            background: linear-gradient(145deg, #e2e2e7, #fcfcff);
            box-shadow: var(--neumorphic-shadow-in); /* Вдавленный по умолчанию */
        ...
        .input-area {
            ...
            padding: 4px;
            background: linear-gradient(145deg, #e2e2e7, #fcfcff);
            box-shadow: var(--neumorphic-shadow-in); /* Вдавленный */
        }
        ...
        .submit-button-element:hover .submit-button-icon-img {
            transform: scale(1.1);
        }
        .submit-button-element:active .submit-button-icon-img {
...
<body>
                ...
                {% if current_user.is_authenticated %}
                    <div class="user-controls-loggedin glass-ui-element">
                        ...
                        <button class="burger-menu-btn neumorphic-btn" id="burger-menu-toggle">
                             <img src="{{ url_for('static', filename='images/JDTI.png') }}" alt="Menu" style="width: 20px; height: 20px;">
                        </button>
                    </div>
    ...
    document.addEventListener('click', (e) => {
        if (dropdownMenu && !dropdownMenu.contains(e.target) && !burgerMenuToggle.contains(e.target)) {
    ...
    const editModeButtons = document.querySelectorAll('#edit-view .button-group .neumorphic-btn');
    ...
    editModeButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            imageDropArea2.parentElement.style.gridTemplateColumns = showSecondImage ? '1fr 1fr' : '1fr';
    ...
    function resetImagePreviews() {
        ...
        document.querySelectorAll('.drop-placeholder-img').forEach(p => p.style.display = 'block');
    ...
    document.getElementById('submit-button-upscale').addEventListener('click', () => { /* Add upscale logic here */ });
